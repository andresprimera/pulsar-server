...
export function encrypt(text: string): string {
  ...
  return `${Buffer.from(iv).toString('hex')}.${Buffer.from(tag).toString('hex')}.${Buffer.from(encrypted).toString('hex')}`;
}
 ...
 */
export function encryptRecord(record: Record<string, any>): Record<string, any> {
 ...
 */
export function decryptRecord(record: Record<string, any>): Record<string, any> {
